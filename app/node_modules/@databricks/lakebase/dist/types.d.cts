 ...
 */
interface LakebasePoolConfig extends PoolConfig {
  /**
 ...
 */
declare enum RequestedClaimsPermissionSet {
  /**
...
//#endregion
export { DatabaseCredential, GenerateDatabaseCredentialRequest, LakebasePoolConfig, Logger, LoggerConfig, RequestedClaims, RequestedClaimsPermissionSet, RequestedResource };
