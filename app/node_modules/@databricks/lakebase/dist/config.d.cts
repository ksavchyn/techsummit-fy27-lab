import { LakebasePoolConfig } from "./types.cjs";
import { WorkspaceClient } from "@databricks/sdk-experimental";
import pg from "pg";

//#region src/config.d.ts
/** Get workspace client from config or SDK default auth chain */
declare function getWorkspaceClient(config: Partial<LakebasePoolConfig>): WorkspaceClient;
/**
 ...
 */
declare function getUsernameWithApiLookup(config?: Partial<LakebasePoolConfig>): Promise<string | undefined>;
//#endregion
export { getUsernameWithApiLookup, getWorkspaceClient };
