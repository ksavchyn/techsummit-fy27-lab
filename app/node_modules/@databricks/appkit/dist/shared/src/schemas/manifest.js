import { PLUGIN_NAME_PATTERN } from "../naming.js";
import { z } from "zod";

//#region ../shared/src/schemas/manifest.ts
/**
...
const pluginManifestSchema = z.object({
	...
	name: z.string().regex(PLUGIN_NAME_PATTERN).describe("Plugin identifier and JS binding. Must start with a lowercase letter; camelCase for multi-word names (e.g. aiSearch)."),
