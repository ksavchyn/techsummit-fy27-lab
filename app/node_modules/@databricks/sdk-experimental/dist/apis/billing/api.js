...
exports.UsageDashboardsService = exports.UsageDashboardsError = exports.UsageDashboardsRetriableError = exports.LogDeliveryService = exports.LogDeliveryError = exports.LogDeliveryRetriableError = exports.BudgetsService = exports.BudgetsError = exports.BudgetsRetriableError = exports.BudgetPolicyService = exports.BudgetPolicyError = exports.BudgetPolicyRetriableError = exports.BillableUsageService = exports.BillableUsageError = exports.BillableUsageRetriableError = void 0;
/**
...
const billing = __importStar(require("./model"));
...
class BillableUsageService {
    ...
    async _download(request, context) {
        ...
        const query = {};
        if (request.hasOwnProperty("end_month")) {
            query["end_month"] =
                request.end_month;
        }
        if (request.hasOwnProperty("personal_data")) {
            query["personal_data"] =
...
class BudgetPolicyRetriableError extends apiError_1.ApiRetriableError {
    constructor(method, message) {
        super("BudgetPolicy", method, message);
    }
}
exports.BudgetPolicyRetriableError = BudgetPolicyRetriableError;
class BudgetPolicyError extends apiError_1.ApiError {
    constructor(method, message) {
        super("BudgetPolicy", method, message);
    }
}
exports.BudgetPolicyError = BudgetPolicyError;
/**
...
class BudgetPolicyService {
    ...
    async _create(request, context) {
        ...
        const body = {};
        if (request.hasOwnProperty("policy")) {
        ...
        const query = {};
        const path = `/api/2.1/accounts/${config.accountId}/budget-policies`;
        return (await this.client.request({
            path,
            method: "POST",
            headers,
    ...
    async _delete(request, context) {
        ...
        const body = undefined;
        const query = {};
        const path = `/api/2.1/accounts/${config.accountId}/budget-policies/${request.policy_id}`;
        return (await this.client.request({
            path,
            method: "DELETE",
            headers,
    ...
    async _list(request, context) {
        ...
        const body = undefined;
        const query = {};
        if (request.hasOwnProperty("filter_by")) {
            query["filter_by"] =
                request.filter_by;
        }
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, context_1.Context]),
    __metadata("design:returntype", Promise)
], BudgetPolicyService.prototype, "_create", null);
__decorate([
    (0, logging_1.withLogContext)(logging_1.ExposedLoggers.SDK),
    __param(1, context_1.context),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, context_1.Context]),
    __metadata("design:returntype", Promise)
], BudgetPolicyService.prototype, "create", null);
__decorate([
    (0, logging_1.withLogContext)(logging_1.ExposedLoggers.SDK),
    __param(1, context_1.context),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, context_1.Context]),
    __metadata("design:returntype", Promise)
], BudgetPolicyService.prototype, "_delete", null);
__decorate([
    (0, logging_1.withLogContext)(logging_1.ExposedLoggers.SDK),
    __param(1, context_1.context),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, context_1.Context]),
    __metadata("design:returntype", Promise)
], BudgetPolicyService.prototype, "delete", null);
__decorate([
    (0, logging_1.withLogContext)(logging_1.ExposedLoggers.SDK),
    __param(1, context_1.context),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, context_1.Context]),
    __metadata("design:returntype", Promise)
], BudgetPolicyService.prototype, "_get", null);
__decorate([
    (0, logging_1.withLogContext)(logging_1.ExposedLoggers.SDK),
    __param(1, context_1.context),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, context_1.Context]),
    __metadata("design:returntype", Promise)
], BudgetPolicyService.prototype, "get", null);
__decorate([
    (0, logging_1.withLogContext)(logging_1.ExposedLoggers.SDK),
    __param(1, context_1.context),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, context_1.Context]),
    __metadata("design:returntype", Promise)
], BudgetPolicyService.prototype, "_list", null);
__decorate([
    (0, logging_1.withLogContext)(logging_1.ExposedLoggers.SDK),
    __param(1, context_1.context),
    __metadata("design:type", Function),
...
], BudgetPolicyService.prototype, "list", null);
__decorate([
    (0, logging_1.withLogContext)(logging_1.ExposedLoggers.SDK),
    __param(1, context_1.context),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, context_1.Context]),
    __metadata("design:returntype", Promise)
], BudgetPolicyService.prototype, "_update", null);
__decorate([
    (0, logging_1.withLogContext)(logging_1.ExposedLoggers.SDK),
    __param(1, context_1.context),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, context_1.Context]),
    __metadata("design:returntype", Promise)
], BudgetPolicyService.prototype, "update", null);
...
class BudgetsService {
    ...
    async _create(request, context) {
        ...
        const body = {};
        if (request.hasOwnProperty("budget")) {
            body["budget"] = request.budget;
        }
        const query = {};
        const path = `/api/2.1/accounts/${config.accountId}/budgets`;
        return (await this.client.request({
            path,
            method: "POST",
            headers,
    ...
    async _delete(request, context) {
        ...
        const body = undefined;
        const query = {};
        const path = `/api/2.1/accounts/${config.accountId}/budgets/${request.budget_id}`;
        return (await this.client.request({
            path,
            method: "DELETE",
            headers,
    ...
    async *list(request, context) {
        while (true) {
            ...
            for (const v of response.budgets) {
                yield v;
            }
            request.page_token = response.next_page_token;
            if (!response.next_page_token) {
...
class LogDeliveryService {
    ...
    async _create(request, context) {
        ...
        const body = {};
        if (request.hasOwnProperty("log_delivery_configuration")) {
            body["log_delivery_configuration"] =
                request.log_delivery_configuration;
        }
        const query = {};
    ...
    async _list(request, context) {
        ...
        if (request.hasOwnProperty("storage_configuration_id")) {
            query["storage_configuration_id"] =
    ...
    async *list(request, context) {
        while (true) {
            ...
            if (!response.log_delivery_configurations ||
                response.log_delivery_configurations.length === 0) {
                break;
            }
            for (const v of response.log_delivery_configurations) {
                yield v;
            }
            request.page_token = response.next_page_token;
            if (!response.next_page_token) {
...
class UsageDashboardsRetriableError extends apiError_1.ApiRetriableError {
    constructor(method, message) {
        super("UsageDashboards", method, message);
    }
}
exports.UsageDashboardsRetriableError = UsageDashboardsRetriableError;
class UsageDashboardsError extends apiError_1.ApiError {
    constructor(method, message) {
        super("UsageDashboards", method, message);
    }
}
exports.UsageDashboardsError = UsageDashboardsError;
/**
...
class UsageDashboardsService {
    ...
    async _create(request, context) {
        ...
        const body = {};
        if (request.hasOwnProperty("dashboard_type")) {
            body["dashboard_type"] = request.dashboard_type;
        }
        if (request.hasOwnProperty("workspace_id")) {
            body["workspace_id"] = request.workspace_id;
        }
        const query = {};
        const path = `/api/2.0/accounts/${config.accountId}/dashboard`;
        return (await this.client.request({
            path,
            method: "POST",
            headers,
...
exports.UsageDashboardsService = UsageDashboardsService;
__decorate([
    (0, logging_1.withLogContext)(logging_1.ExposedLoggers.SDK),
    __param(1, context_1.context),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, context_1.Context]),
    __metadata("design:returntype", Promise)
], UsageDashboardsService.prototype, "_create", null);
__decorate([
    (0, logging_1.withLogContext)(logging_1.ExposedLoggers.SDK),
    __param(1, context_1.context),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, context_1.Context]),
    __metadata("design:returntype", Promise)
], UsageDashboardsService.prototype, "create", null);
__decorate([
    (0, logging_1.withLogContext)(logging_1.ExposedLoggers.SDK),
    __param(1, context_1.context),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, context_1.Context]),
    __metadata("design:returntype", Promise)
], UsageDashboardsService.prototype, "_get", null);
__decorate([
    (0, logging_1.withLogContext)(logging_1.ExposedLoggers.SDK),
    __param(1, context_1.context),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, context_1.Context]),
    __metadata("design:returntype", Promise)
], UsageDashboardsService.prototype, "get", null);
