...
const provisioning = __importStar(require("./model"));
...
class CredentialsService {
    ...
    async _create(request, context) {
        ...
        const body = {};
        if (request.hasOwnProperty("aws_credentials")) {
            body["aws_credentials"] = request.aws_credentials;
        }
        if (request.hasOwnProperty("credentials_name")) {
...
class EncryptionKeysService {
    ...
    async _create(request, context) {
        ...
        const body = {};
        if (request.hasOwnProperty("aws_key_info")) {
            body["aws_key_info"] = request.aws_key_info;
        }
        if (request.hasOwnProperty("gcp_key_info")) {
            body["gcp_key_info"] = request.gcp_key_info;
        }
        if (request.hasOwnProperty("use_cases")) {
...
class NetworksService {
    ...
    async _create(request, context) {
        ...
        const body = {};
        if (request.hasOwnProperty("gcp_network_info")) {
            body["gcp_network_info"] = request.gcp_network_info;
        }
        if (request.hasOwnProperty("network_name")) {
            body["network_name"] = request.network_name;
        }
        if (request.hasOwnProperty("security_group_ids")) {
            body["security_group_ids"] = request.security_group_ids;
        }
        if (request.hasOwnProperty("subnet_ids")) {
            body["subnet_ids"] = request.subnet_ids;
        }
        if (request.hasOwnProperty("vpc_endpoints")) {
            body["vpc_endpoints"] = request.vpc_endpoints;
        }
        if (request.hasOwnProperty("vpc_id")) {
...
class PrivateAccessService {
    ...
    async _create(request, context) {
        ...
        const body = {};
        if (request.hasOwnProperty("allowed_vpc_endpoint_ids")) {
            body["allowed_vpc_endpoint_ids"] = request.allowed_vpc_endpoint_ids;
        }
        if (request.hasOwnProperty("private_access_level")) {
            body["private_access_level"] = request.private_access_level;
        }
        if (request.hasOwnProperty("private_access_settings_name")) {
            body["private_access_settings_name"] =
                request.private_access_settings_name;
        }
        if (request.hasOwnProperty("public_access_enabled")) {
            body["public_access_enabled"] = request.public_access_enabled;
        }
     ...
     * your workspace is accessed over AWS PrivateLink. To use AWS PrivateLink, a
     * workspace must have a private access settings object referenced by ID in
     * the workspace's private_access_settings_id property. This operation
     ...
     * settings are affected by any change. If public_access_enabled,
     ...
     * a given private access settings object. Before configuring PrivateLink,
     * read the Databricks article about PrivateLink.
     */
...
class StorageService {
    ...
    async _create(request, context) {
        ...
        const body = {};
        if (request.hasOwnProperty("role_arn")) {
            body["role_arn"] = request.role_arn;
        }
        if (request.hasOwnProperty("root_bucket_info")) {
            body["root_bucket_info"] = request.root_bucket_info;
        }
        if (request.hasOwnProperty("storage_configuration_name")) {
            body["storage_configuration_name"] =
                request.storage_configuration_name;
        }
        const query = {};
...
class VpcEndpointsService {
    ...
    async _create(request, context) {
        ...
        const body = {};
        if (request.hasOwnProperty("aws_vpc_endpoint_id")) {
            body["aws_vpc_endpoint_id"] = request.aws_vpc_endpoint_id;
        }
        if (request.hasOwnProperty("gcp_vpc_endpoint_info")) {
            body["gcp_vpc_endpoint_info"] = request.gcp_vpc_endpoint_info;
        }
        if (request.hasOwnProperty("region")) {
            body["region"] = request.region;
        }
        if (request.hasOwnProperty("vpc_endpoint_name")) {
...
class WorkspacesService {
    ...
    async _create(request, context) {
        ...
        const body = {};
        if (request.hasOwnProperty("aws_region")) {
            body["aws_region"] = request.aws_region;
        }
        if (request.hasOwnProperty("cloud")) {
            body["cloud"] = request.cloud;
        }
        if (request.hasOwnProperty("cloud_resource_container")) {
            body["cloud_resource_container"] = request.cloud_resource_container;
        }
        if (request.hasOwnProperty("compute_mode")) {
            body["compute_mode"] = request.compute_mode;
        }
        if (request.hasOwnProperty("credentials_id")) {
            body["credentials_id"] = request.credentials_id;
        }
        if (request.hasOwnProperty("custom_tags")) {
            body["custom_tags"] = request.custom_tags;
        }
        if (request.hasOwnProperty("deployment_name")) {
            body["deployment_name"] = request.deployment_name;
        }
        if (request.hasOwnProperty("gcp_managed_network_config")) {
            body["gcp_managed_network_config"] =
                request.gcp_managed_network_config;
        }
        if (request.hasOwnProperty("gke_config")) {
            body["gke_config"] = request.gke_config;
        }
        if (request.hasOwnProperty("location")) {
            body["location"] = request.location;
        }
        if (request.hasOwnProperty("managed_services_customer_managed_key_id")) {
            body["managed_services_customer_managed_key_id"] =
                request.managed_services_customer_managed_key_id;
        }
        if (request.hasOwnProperty("network_connectivity_config_id")) {
            body["network_connectivity_config_id"] =
                request.network_connectivity_config_id;
        }
        if (request.hasOwnProperty("network_id")) {
            body["network_id"] = request.network_id;
        }
        if (request.hasOwnProperty("pricing_tier")) {
            body["pricing_tier"] = request.pricing_tier;
        }
        if (request.hasOwnProperty("private_access_settings_id")) {
            body["private_access_settings_id"] =
                request.private_access_settings_id;
        }
        if (request.hasOwnProperty("storage_configuration_id")) {
            body["storage_configuration_id"] = request.storage_configuration_id;
        }
        if (request.hasOwnProperty("storage_customer_managed_key_id")) {
            body["storage_customer_managed_key_id"] =
                request.storage_customer_managed_key_id;
        }
        if (request.hasOwnProperty("workspace_name")) {
     ...
     * make repeated GET requests with the workspace ID and check its status. The
     ...
     * However, you cannot reuse subnets or Security Groups between workspaces.
     * If you plan to share one VPC with multiple workspaces, make sure you size
     * your VPC and subnets accordingly. Because a Databricks Account API network
    ...
    async _update(request, context) {
        ...
        const body = request.customer_facing_workspace;
        const query = {};
    ...
    async update(updateWorkspaceRequest, context) {
        let cancellationToken = context?.cancellationToken;
        const workspace = await this._update(updateWorkspaceRequest, context);
        return (0, wait_1.asWaiter)(workspace, async (options) => {
            options = options || {};
            options.onProgress =
                options.onProgress || (async (newPollResponse) => { });
