...
describe(__filename, () => {
    ...
    describe("discover", () => {
        ...
        it("should return an instance of Issuer for account client", async () => {
            ...
            const result = await cfg.getOidcEndpoints();
            assert_1.default.ok(result instanceof OidcEndpoints_1.OidcEndpoints);
            assert_1.default.deepStrictEqual(result.authorizationEndpoint.toString(), "https://accounts.cloud.databricks.com/oidc/accounts/123/v1/authorize");
            assert_1.default.deepStrictEqual(result.tokenEndpoint.toString(), "https://accounts.cloud.databricks.com/oidc/accounts/123/v1/token");
        });
    });
});
