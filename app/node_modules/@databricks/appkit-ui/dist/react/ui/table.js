...
function TableCell({ className, ...props }) {
	return /* @__PURE__ */ jsx("td", {
		...
		className: cn("p-2 align-middle whitespace-nowrap [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px] text-foreground", className),
		...props
	});
}
