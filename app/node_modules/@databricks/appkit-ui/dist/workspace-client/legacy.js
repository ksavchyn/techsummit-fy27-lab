...
function buildLegacyWorkspaceClient(opts) {
	...
	} : opts.host ? { host: opts.host } : opts.profile ? { profile: opts.profile } : {}, opts.clientOptions);
}
const { ConfigError, Context, TimeUnits, loadConfigFile } = SDK;
const Time = SDK.Time ?? SDK.default.Time;

//#endregion
export { ConfigError, Context, Time, TimeUnits, buildLegacyWorkspaceClient, loadConfigFile };
